...
(
	...
	C_PASS_HASHER				SMALLINT		NOT NULL DEFAULT 0,
	C_PASS_HASH					VARCHAR(200),
	IS_DELETED					BOOLEAN			NOT NULL DEFAULT FALSE,
	C_CREATE_TIME				TIMESTAMP,
	C_DELETE_TIME				TIMESTAMP,
	IS_LOCKED					BOOLEAN			NOT NULL DEFAULT FALSE,
	IS_EXPIRED					BOOLEAN			NOT NULL DEFAULT FALSE,
	RC_LOGIN_COUNT				INTEGER			NOT NULL DEFAULT 0,
...
(
	...
	C_PASS_HASHER		SMALLINT,
	C_PASS_HASH			VARCHAR(200),
	IS_LOCKED			BOOLEAN			NOT NULL DEFAULT FALSE,
	IS_EXPIRED			BOOLEAN			NOT NULL DEFAULT FALSE,
	C_LOGIN_COUNT		INTEGER			NOT NULL DEFAULT 0,
...
(
	D_TYPE			SMALLINT		NOT NULL DEFAULT 0,
	PK_ID			CHAR(25)		PRIMARY KEY,
...
(
	PK_ID			CHAR(25)		PRIMARY KEY,
	UQ_ACCOUNT		VARCHAR(255)	NOT NULL UNIQUE
);
...
(
	PK_ID				CHAR(25)		PRIMARY KEY,
	C_STATUS			SMALLINT		DEFAULT 0 NOT NULL,
	C_USER_AGENT		VARCHAR(200),
	C_CREATE_TIME		TIMESTAMP,
	C_REFRESH_TIME		TIMESTAMP,
	FK_LOGIN_RECORD_ID	CHAR(25),
	C_VISIT_TIMES		INT				DEFAULT 0 NOT NULL,
	C_LOGIN_TIMES		INT				DEFAULT 0 NOT NULL
);
...
(
	...
	FK_USER_ID			CHAR(25)		NOT NULL,
	FK_SESSION_ID		CHAR(25)		NOT NULL,
	C_LOGIN_STATUS		SMALLINT		DEFAULT 0 NOT NULL,
	C_LOGIN_TIME		TIMESTAMP,
	C_REQUEST_TIMES		INT				DEFAULT 0 NOT NULL,
	C_LAST_REQUEST_TIME	TIMESTAMP,
	C_QUIT_TIME			TIMESTAMP,
	C_CREATE_TIME		TIMESTAMP,
	C_LOGIN_ACCOUNT		VARCHAR(255)
);
