 ...
 * 
 * FileName:   DemoSessionRegistryImpl.java
 * CreateTime: 2016-02-02 14:08:46
 */
 ...
 * @since   0.0.1
 */
public class DemoSessionRegistryImpl
	implements SessionRegistry
{

	private static final Logger logger = getLogger(DemoSessionRegistryImpl.class);
		...
		extends SessionInformation
	{
		...
		public void refreshLastRequest()
		{
			...
			DemoSessionRegistryImpl.this.refreshLastRequest(getSessionId(), getLastRequest());
		}
		...
		public void expireNow()
		{
			...
			DemoSessionRegistryImpl.this.expireNow(getSessionId());
		}
	...
	private LoginRecord getLoginRecord(String sessionId)
	{
		...
		notNull(activity = this.activitySessionDao.findOne(sessionId),
				"系统没有容器的会话记录[" + sessionId + "]，检查是否已经正确配置SessionRefreshFilter");
		notNull(session = activity.getSession(),
				"没有系统的会话记录，检查是否已经正确配置SessionRefreshFilter");
	...
	private Object toPrincipal(LoginRecord loginRecord)
	{
		if (loginRecord instanceof StandardLoginRecord)
		{
			...
			return new DemoUserDetails(user, account);
		}
	...
	{
		if (principal instanceof DemoUserDetails)
		{
			StandardLoginRecord rec = this.loginRecordDao.blank(StandardLoginRecord.class);

			rec.setLoginAccount(((DemoUserDetails) principal).getUsername());
	...
	/* (non-Javadoc)
	 * @see org.springframework.security.core.session.SessionRegistryImpl#getAllPrincipals()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.springframework.security.core.session.SessionRegistryImpl#getAllSessions(java.lang.Object, boolean)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.springframework.security.core.session.SessionRegistryImpl#getSessionInformation(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.springframework.security.core.session.SessionRegistryImpl#refreshLastRequest(java.lang.String)
	 */
	@Override
