...
<link type="text/css" rel="stylesheet" href="/libs/rickshaw/rickshaw.css" />
<link type="text/css" rel="stylesheet" href="/libs/morris/morris.core.css" />
<!-- END STYLESHEETS -->

<!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
<!--[if lt IE 9]>
<script integrity="sha384-eF8v9i73obDzur3vBtv7BYLMg+3TmsAABTGw7xB86PMRi1I4NyIHg4ul/CDanpR1" crossorigin="anonymous" type="text/javascript" src="http://cdnjs.cloudflare.com/ajax/libs/html5shiv/3.6.2pre/html5shiv.js"></script>
...
<script integrity="sha384-Xtz2F6lyH327Ss8Oo7ji6fYdvuZEC51BeIcxotR5gMncyQSiybXw4IefID59fGvq" crossorigin="anonymous" type="text/javascript" src="http://cdnjs.cloudflare.com/ajax/libs/moment.js/2.9.0/moment.min.js"></script>
<script type="text/javascript" src="/core/cache/ec2c8835c9f9fbb7b8cd36464b491e73.js"></script>
<script type="text/javascript" src="/libs/jquery-knob/jquery.knob.min.js"></script>
<script type="text/javascript" src="/libs/sparkline/jquery.sparkline.min.js"></script>
<script type="text/javascript" src="/libs/nanoscroller/jquery.nanoscroller.min.js"></script>
<script type="text/javascript" src="/core/cache/43ef607ee92d94826432d1d6f09372e1.js"></script>
<script type="text/javascript" src="/libs/rickshaw/rickshaw.min.js"></script>
...
<script type="text/javascript" src="/core/demo/demo-dashboard.js"></script>
<!-- END JAVASCRIPT -->
</head>
				...
				<ul class="dropdown-menu animation-expand">
					...
					<li>
						<a class="alert alert-callout alert-warning" href="javascript:void(0);">
							<img class="pull-right img-circle dropdown-avatar" src="/images/avatar2.jpg" alt="" />
					...
					<li>
						<a class="alert alert-callout alert-info" href="javascript:void(0);">
							<img class="pull-right img-circle dropdown-avatar" src="/images/avatar3.jpg" alt="" />
		...
		<ul class="header-nav header-nav-profile">
			<li class="dropdown">
				...
				<ul class="dropdown-menu animation-dock">
					...
					<li><form action="/security/logout" id="logoutForm" method="post" style="display: none;"><input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" /></form><a href="#" onclick="$('#logoutForm').submit(); return false;"><i class="fa fa-fw fa-power-off text-danger"></i> Logout</a></li>
				</ul><!--end .dropdown-menu -->
			</li><!--end .dropdown -->
...
<ul id="main-menu" class="gui-controls">
	<!-- BEGIN DASHBOARD -->
	<li>
		<a href="http://www.codecovers.eu/materialadmin/dashboards/dashboard" class="active">
...
<div id="offcanvas-chat" class="offcanvas-pane style-default-light width-12">
	...
	<div class="offcanvas-body">
		<ul class="list-chats">
			<li>
				<div class="chat">
					<div class="chat-avatar"><img class="img-circle" src="/images/avatar1.jpg" alt="" /></div>
					<div class="chat-body">
			...
			<li class="chat-left">
				<div class="chat">
					<div class="chat-avatar"><img class="img-circle" src="/images/avatar9.jpg" alt="" /></div>
					<div class="chat-body">
